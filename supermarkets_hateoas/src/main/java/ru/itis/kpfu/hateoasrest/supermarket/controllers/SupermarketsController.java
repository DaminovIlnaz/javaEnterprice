package ru.itis.kpfu.hateoasrest.supermarket.controllers;
...
public class SupermarketsController {
    private static final Logger log = LoggerFactory.getLogger(SupermarketsController.class);
    @Autowired
    private SupermarketsService supermarketsService;

    public SupermarketsController() {
    }
